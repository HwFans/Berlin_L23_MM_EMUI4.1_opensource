...
void st_get_rawdata_test(struct ts_rawdata_info *info, struct ts_data *chip_data, struct ts_device_data *device_data)
{
	int ret = 0;
	...
	limit_data.MutualRawMax = device_data->raw_limit_buf[0];//5400;
	limit_data.MutualRawMin = device_data->raw_limit_buf[1];//4600;
	limit_data.MutualCx2Max = device_data->raw_limit_buf[2];//36;
	limit_data.MutualCx2Min = device_data->raw_limit_buf[3];//5;
	limit_data.SelfForceRawMax = device_data->raw_limit_buf[4];//10500;
	limit_data.SelfForceRawMin = device_data->raw_limit_buf[5];//7500;
	limit_data.SelfForceIxTotalMax = device_data->raw_limit_buf[6];//170;
	limit_data.SelfForceIxTotalMin = device_data->raw_limit_buf[7];//130; 
	limit_data.SelfSenseRawMax = device_data->raw_limit_buf[8];//10500;
	limit_data.SelfSenseRawMin = device_data->raw_limit_buf[9];//7500;
	limit_data.SelfSenseIxTotalMax = device_data->raw_limit_buf[10];//105;
	limit_data.SelfSenseIxTotalMin = device_data->raw_limit_buf[11];//65;

	limit_data.MutualStrengthMin = device_data->raw_limit_buf[12];//-100;
	limit_data.MutualStrengthMax = device_data->raw_limit_buf[13];//100;
	...
	if (TestRes.MutualRawRes && TestRes.SelfForceRawRes && TestRes.SelfSenseRawRes){
	...
	TS_LOG_INFO("result size is %d\n", strlen(info->result));
	info->buff[0] = getSenseLen() + 1;
	info->buff[1] = getForceLen() + 1;
